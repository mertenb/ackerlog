...
import { NutrientComponent } from 'app/entities/nutrient/nutrient.component';
...
describe('Component Tests', () => {
    describe('Nutrient Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.nutrients[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
